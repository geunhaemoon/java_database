...
public class Main2 {
	...
	public static void main(String[] args) {
		System.out.println(getProductMyProductCode(20230701));
		insertProduct(20230707, "상품7");
		System.out.println(getProductMyProductCode(20230707));
	...
	public static Map<String, Object> getProductMyProductCode(int productCode) {
